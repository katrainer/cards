...
export const modalReducer = (state: modalReducerType = initialState, action: ModalReducerActionType): modalReducerType => {
    switch (action.type) {
...
export type ModalReducerActionType =
    | ReturnType<typeof setActiveModalAC>
    | ReturnType<typeof deletePackModalAC>
    | ReturnType<typeof updatePackModalAC>
    | ReturnType<typeof addPackModalAC>